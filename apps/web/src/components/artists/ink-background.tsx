...
export function InkBackground() {
  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center overflow-hidden pointer-events-none -z-10">
      ...
      >
        <svg viewBox="0 0 200 200" width="480" height="480">
          
          {/* ─── YIN-YANG OUTLINE ─────────────────────────────────────────────── */}
          {/* Outer circle */}
          <motion.circle
            cx="100" cy="100" r="95"
            stroke="#d1d5db" strokeWidth="0.6" fill="none"
          ...
          <motion.path
            ...
            stroke="#9ca3af" strokeWidth="0.4" fill="none"
            initial={{ pathLength: 0, opacity: 0 }}
          ...
          <motion.path
            ...
            stroke="#9ca3af" strokeWidth="0.3" fill="none"
          ...
          <motion.path
            ...
            stroke="#9ca3af" strokeWidth="0.25" fill="none"
            initial={{ pathLength: 0 }}
            animate={{ pathLength: [0, 1, 0] }}
          ...
          <motion.path
            ...
            stroke="#6b7280" strokeWidth="0.5" fill="none"
            initial={{ pathLength: 0, opacity: 0 }}
            animate={{ pathLength: [0, 1, 1, 0], opacity: [0, 0.8, 0.8, 0] }}
          ...
          <motion.path
            ...
            stroke="#6b7280" strokeWidth="0.4" fill="none"
            initial={{ pathLength: 0, opacity: 0 }}
            animate={{ pathLength: [0, 1, 1, 0], opacity: [0, 0.6, 0.6, 0] }}
          ...
          <motion.path
            ...
            stroke="#6b7280" strokeWidth="0.3" fill="none"
            initial={{ pathLength: 0 }}
            animate={{ pathLength: [0, 1, 0] }}
          ...
          <motion.path
            ...
            stroke="#6b7280" strokeWidth="0.25" fill="none"
            initial={{ pathLength: 0 }}
            animate={{ pathLength: [0, 1, 0] }}
